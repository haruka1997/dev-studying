...
(function() {
    ...
    function fieldListController($scope,$http,$timeout) {
        ...
        function clickField(name){
            ...
            //選択コースしたコースによって画面変更
            switch(Number($scope.indexCtrl.value.course)){
                case 0:
...
// module
exports.push([module.i, "/*ヘッダーメニュー*/\n.fieldList-header-menu{\n    font-size: 0.9em;\n    margin-top: 10px;\n    margin-left: 30px;\n}\n\n.fieldList-header-menu .btn-primary{\n    background-color:#4790BB;\n}\n\n.fieldList-header-menu .btn-primary:hover,\n.fieldList-header-menu .btn-primary:after{\n    color: #fff;\n    background-color:#426880;\n}\n/*コンテンツ*/\n.fieldList-menu {\n    width: 500px;\n    padding: 0;\n    margin: 30px;\n}\n.fieldList-menu li {\n    overflow: hidden;\n    border-bottom: 1px solid #fff;\n    cursor: pointer;\n}\n\n.fieldList-menu li a {\n    display: block;\n    position: relative;\n    padding: 0px 10px 0px 50px;\n    background: #f2f2f2;\n    color: #494949;\n    font-size: 14px;\n    line-height: 40px;\n}\n\n.fieldList-menu li a:before {\n    display: block;\n    content: \"\";\n    position: absolute;\n    top: 50%;\n    left: 25px;\n    width: 8px;\n    height: 8px;\n    margin-top: -4px;\n    border-radius: 50%;\n    background: #4790BB;\n    transition-property:all;\n    transition: 0.2s linear;\n    color: #494949;\n}\n.fieldList-menu li a:hover:before {\n    left: -16px;\n    width: 50px;\n    height: 50px;\n    margin-top: -25px;\n    transition-property:all;\n    transition: 0.2s linear;\n    color: #494949;\n}\n\n.collapsed:hover{\n    color:#494949;\n}\n", ""]);

...
(function() {
    ...
    function mainController($scope) {
        ...
        //imageインポート
        mainCtrl.value.src.explain = __webpack_require__(10);
        mainCtrl.value.src.problem =__webpack_require__(11);
        mainCtrl.value.src.board =__webpack_require__(12);
        mainCtrl.value.src.makeExplain =__webpack_require__(13);
        mainCtrl.value.src.makeProblem =__webpack_require__(14);
        init();
